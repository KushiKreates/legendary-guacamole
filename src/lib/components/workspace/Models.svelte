...
<div class=" text-lg font-semibold mb-3">{$i18n.t('Characters 👲👩')}</div>
...
<div class=" flex w-full space-x-2">
	<div class="flex flex-1">
		...
		<input
			...
			placeholder={$i18n.t('Astral Axis ©️ 2024')}
		/>
	</div>
...
<a class=" flex space-x-4 cursor-pointer w-full mb-2 px-3 py-2" href="/workspace/models/create">
	...
	<div class=" self-center">
		<div class=" font-bold line-clamp-1">{$i18n.t('Characters 👲👩 Magic maker')}</div>
		<div class=" text-sm line-clamp-1">{$i18n.t('Create Characters 👲👩 for anything!')}</div>
	</div>
</a>
