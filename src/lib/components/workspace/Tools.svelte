...
<div class=" text-pink-900 text-xs mt-2 mb-6">
	ⓘ {$i18n.t(
...
<div class=" my-16">
	...
	<div class="self-center w-10 flex-shrink-0">
		<div
			class=" flex justify-center rounded-full bg-transparent dark:bg-gray-700 border border-dashed border-gray-200"
		>
			<img src="https://media.tenor.com/hYkRcm80JFwAAAAj/foxy-foxplushy.gif" alt="Icon" class="w-6 h-6" />
		</div>
		</div>

		<div class=" self-center">
			<div class=" font-bold line-clamp-1">{$i18n.t('This feature is currently down ⛔')}</div>
			<div class=" text-sm line-clamp-1">
				{$i18n.t('Please note that, ourr panel is not finshed')}
			</div>
		</div>
	</a>
</div>
