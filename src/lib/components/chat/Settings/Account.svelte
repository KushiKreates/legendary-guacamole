		...
		<div class="space-y-1">
			...
			<div class="flex space-x-5">
				...
				<div class="flex-1 flex flex-col self-center gap-0.5">
					<div class=" mb-0.5 text-sm font-medium">{$i18n.t('🥺 Avatar')}</div>

					<div>
						<button
							class=" text-xs text-center text-gray-800 dark:text-black-400 rounded-full px-4 py-0.5 bg-gray-100 dark:bg-pink-150"
							on:click={async () => {
								if (canvasPixelTest()) {
									profileImageUrl = generateInitialsImage(name);
								} else {
						...
						<button
							class=" text-xs text-center text-gray-800 dark:text-pink-400 rounded-full px-4 py-0.5 bg-gray-100 dark:bg-gray-850"
							on:click={async () => {
						...
						<button
							class=" text-xs text-center text-gray-800 dark:text-blue-400 rounded-lg px-2 py-1"
							on:click={async () => {
			...
			<div class="pt-0.5">
				<div class="flex flex-col w-full">
					...
					<div class="flex-1">
						<input
							class="w-full rounded-lg py-2 px-4 text-sm dark:text-pink-400 dark:bg-pink-850 bold"
							type="text"
							bind:value={name}
							required
						/>
