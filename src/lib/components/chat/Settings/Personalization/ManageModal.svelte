...
<Modal size="xl" bind:show>
	<div>
		...
		<div class="flex flex-col w-full px-5 pb-5 dark:text-pink-900">
			<div
				...
				{#if memories.length > 0}
					<div class="text-left text-sm w-full mb-4 overflow-y-scroll">
						<div class="relative overflow-x-auto">
							<table class="w-full text-sm text-left text-white-600 dark:text-pink-900 table-auto">
								<thead
									class="text-xs text-gray-700 uppercase bg-transparent dark:text-pink-900 border-b-2 dark:border-gray-800"
								>
									<tr>
